  ...
  return (
    <div>
      <div
        ...
        "
      >
        Create quality images that exceed expectations and meet unique requirements.
      </div>

      <div className="grid grid-cols-4 p-4 md:flex">
        <AnimatePresence
        custom={currentImageIndex}>
            {images.map((image, index) => (
                ...
                initial={{ opacity: 0 }}
                animate={{
                    opacity : index === currentImageIndex ? 4 : 0.8,
